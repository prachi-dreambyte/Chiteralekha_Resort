...
const whyPanels = [
  { src: '/assets/images/n1.webp', label: 'Stunning Views', description: "Wake up to Dehradun’s emerald valleys and misty Himalayan peaks—every glance feels like a painting come to life.",},
  { src: '/assets/images/n2.webp', label: 'Sukoon', description:"A space within Chitralekha where every word calms the mind, every story soothes the soul, and moments feel lighter, warmer, and more peaceful." ,},
  { src: '/assets/images/n3.webp', label: 'Luxury Rooms', description:"Experience the perfect blend of comfort and elegance — our luxury rooms are crafted to offer you serene views, plush interiors, and a stay that feels like royalty." ,},
  { src: '/assets/images/n4.webp', label: 'Destination Wedding', description:"Turn your dream wedding into a timeless memory — celebrate love in the heart of a stunning destination, where every moment is wrapped in elegance, charm, and unforgettable beauty." ,},
